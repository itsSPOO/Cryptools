...
export const toolSEOConfig: Record<string, PageSEO> = {
  ...
  base64: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/base64',
  ...
  binary: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/binary',
  ...
  url: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/url',
  ...
  hex: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/hex',
  ...
  leet: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/leet',
  ...
  md5: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/md5',
  ...
  sha1: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/sha1',
  ...
  sha256: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/sha256',
  ...
  caesar: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/caesar',
  ...
  rot13: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/rot13',
  ...
  vigenere: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/vigenere',
  ...
  atbash: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/atbash',
  ...
  custom: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/custom',
  ...
  password: {
    ...
    structuredData: {
      ...
      url: 'https://cryptools.click/tool/password',
